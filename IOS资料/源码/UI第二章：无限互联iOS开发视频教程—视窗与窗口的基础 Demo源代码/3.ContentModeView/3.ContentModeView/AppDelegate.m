...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions
{
    ...
    UIImageView *imgView1 = [[UIImageView alloc] initWithFrame:CGRectMake(320/2-200/2.0, 30, 200, 200)];
    ...
    UIImageView *imgView2 = [[UIImageView alloc] initWithFrame:CGRectMake(320/2-220/2.0, 240, 220, 200)];
    imgView2.backgroundColor = [UIColor yellowColor];
    imgView2.image = [UIImage imageNamed:@"01"];
